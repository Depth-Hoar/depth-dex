...
describe('Exchange', () => {
  ...
  beforeEach(async () => {
    ...
    token1 = await Token.deploy('Depth Token', 'DEPTH', '1000000');
  ...
  describe('Depositing to Exchange', () => {
    ...
    describe('Failure', () => {
      ...
      it('fails when no tokens are approved', async () => {
        await expect(exchange.connect(user1).depositToken(token1.address, amount)).to.be.rejected
      })
  ...
  describe('Withdrawing from Exchange', () => {
    let transaction, result;
    let amount = tokens(10);
    ...
    describe('Failure', () => {
      ...
      it('fails for insufficient balance', async () => {
        ...
        await expect(exchange.connect(user1).withdrawToken(token1.address, amount)).to.be.rejected
      })
